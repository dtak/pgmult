...
from ctm import get_sparse_repr, split_test_train, plot_predictive_lls
...
if __name__ == '__main__':
    ...
    K, V = 5, 100
    alpha_theta = 1.
    train_frac, test_frac = 0.90, 0.10
    ...
    plot_predictive_lls(sb_results, False, color=colors[1], label='SB DTM Gibbs')
    plt.show()
    ...
    with open('dtm_smehr_results.pkl', 'w') as outfile:
